...
async fn provisioning_creates_the_row_the_schema_and_the_migrations() {
    ...
    // favourites and watches; 68 since 0020 added comments and their routing; 72 since 0025 added orders and their items; 70 since 0023 added `conversions`; 69 since 0021 added the
    // events default partition.
    assert_eq!(tables, 72);
}
